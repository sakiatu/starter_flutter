...
class UpdatePage extends GetView<UpdateController> {
  ...
  const UpdatePage(this.link, {super.key});
  ...
  Widget _button(BuildContext context) => Obx(() => MyButton(
      title: MyString.updateButton,
      loading: controller.loading.value,
      onClick: () => controller.onUpdateClick(link)).paddingY());
}
